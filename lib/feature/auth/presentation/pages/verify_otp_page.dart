...
listenToIncomingSMS();
  if(mounted){
    ...
    Future.delayed(const Duration(minutes: 2,seconds: 1)).whenComplete(() {
      ...
      context.read<AuthBloc>().add(AuthPhoneLogin(phoneNo: widget.phoneNo, context: context));
    });
  }
          ...
          child:BlocConsumer<AuthBloc,AuthState>(builder: (context, state) {
                  ...
                  Pinput(
                    submittedPinTheme:  PinTheme(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(color: const Color(0xFF03AAD6),width: 2)
                        )),
                    ...
                    disabledPinTheme: PinTheme(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(color: const Color(0xFF1F54BC),width: 2)
                        )),
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          'Verify',
                          style:
                          TextStyle(color:Colors.white,fontSize: width * 0.04,fontFamily: "Montserrat",fontWeight: FontWeight.bold),
                        ),
                      ),
                    ),
                  )
            ...
            if (state is AuthFailure) {
              ...
              if(state.success==""){
                ...
                Navigator.pushAndRemoveUntil(context, CupertinoPageRoute(builder: (context) => HomePage( data: data,id:state.success ,) ,), (route) => false);
              }
